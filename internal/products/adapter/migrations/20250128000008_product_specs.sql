...
CREATE INDEX IF NOT EXISTS idx_product_specs_deleted_at ON product_specs(deleted_at);
CREATE INDEX IF NOT EXISTS idx_product_specs_product_id ON product_specs(product_id);
CREATE INDEX IF NOT EXISTS idx_product_specs_order ON product_specs(product_id, "order");

...
CREATE INDEX IF NOT EXISTS idx_product_details_color_key ON product_details(color_key) WHERE color_key IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_product_details_size_key ON product_details(size_key) WHERE size_key IS NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS uk_product_details_unique ON product_details(product_id, COALESCE(color_key, ''), COALESCE(size_key, ''));

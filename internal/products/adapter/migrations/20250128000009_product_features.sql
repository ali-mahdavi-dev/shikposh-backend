...
CREATE INDEX IF NOT EXISTS idx_product_features_deleted_at ON product_features(deleted_at);
CREATE INDEX IF NOT EXISTS idx_product_features_product_id ON product_features(product_id);
CREATE INDEX IF NOT EXISTS idx_product_features_order ON product_features(product_id, "order");
